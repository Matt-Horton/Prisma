    ...
    <section id="partner" className="contact-us-section">
      <Container>
        <div className="contact-row">
          ...
          <hr />
          <p className="section-info">We are currently participating in NorthByNorthwest's LLP course, exploring the market for the potential commercialisation of our technology. We are actively looking for partners, both academic and in industry. Please reach out if you are interested in our technology or wish to collaborate with us. Let’s work together!</p>
        </div>
        <div>
